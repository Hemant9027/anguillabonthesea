...
export default function AdminGalleryPage() {
  ...
  // Filters
  const [activeSection, setActiveSection] = useState<GallerySectionKey | "all">("all");
  ...
  const fetchGallery = useCallback(async () => {
    ...
    try {
      ...
      if (activeSection !== "all") params.append("section", activeSection);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#78716C] mt-1 max-w-2xl">
            Manage villa photography by section, reorder display sequences, optimize SEO
            alt text, and upload new media.
          </p>
        </div>
