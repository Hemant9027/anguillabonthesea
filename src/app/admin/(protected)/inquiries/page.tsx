    ...
    <div className="space-y-6 animate-fade-in">
      <div className="bg-white rounded-2xl border border-[#E7E5E4] p-8 sm:p-12 text-center max-w-2xl mx-auto shadow-sm">
        ...
        <p className="text-sm text-[#78716C] leading-relaxed mb-6">
          The route structure and authentication guard for Guest Inquiries are active. Contact messages, date inquiries, and direct response tools will be implemented in subsequent steps.
        </p>
