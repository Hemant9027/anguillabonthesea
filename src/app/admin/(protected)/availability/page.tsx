...
export const metadata = {
  title: "Availability — Villa B Admin",
};
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="bg-white rounded-2xl border border-[#E7E5E4] p-8 sm:p-12 text-center max-w-2xl mx-auto shadow-sm">
        ...
        <p className="text-sm text-[#78716C] leading-relaxed mb-6">
          The route structure and authentication guard for Villa Availability are active. Master calendar, date blocking, and sync feeds will be implemented in subsequent steps.
        </p>
